...
function AboutUs() {
    ...
    const [showLowPrototype, setShowLowPrototype] = useState(false);
    const [showMedPrototype, setShowMedPrototype] = useState(false);
    const [showHighPrototype, setShowHighPrototype] = useState(false);
        ...
        <div className="container">
            <div className="item">
                <div className="aboutus">
                    ...
                    <div className="section">
                        <h1 onClick={() => setShowNeed(!showNeed)} style={{ cursor: 'pointer' }}>
                            Need finding {showNeed ? '▲' : '▼'}
                        </h1>
                        {showNeed && (
                            <div></div>
                        )}
                    ...
                    <div className="section">
                        <h1 onClick={() => setShowConcept(!showConcept)} style={{ cursor: 'pointer' }}>
                            Concept video {showConcept ? '▲' : '▼'}
                        </h1>
                        {showConcept && (
                            <div></div>
                        )}
                    ...
                    <div className="section">
                        <h1 onClick={() => setShowLowPrototype(!showLowPrototype)} style={{ cursor: 'pointer' }}>
                            Low-Fidelity Prototype {showLowPrototype ? '▲' : '▼'}
                        </h1>
                        {showLowPrototype&& (
                            <div></div>
                        )}
                    ...
                    <div className="section">
                        <h1 onClick={() => setShowMedPrototype(!showMedPrototype)} style={{ cursor: 'pointer' }}>
                            Medium-Fidelity Prototype {showMedPrototype ? '▲' : '▼'}
                        </h1>
                        {showMedPrototype && (
                            <div></div>
                        )}
                    ...
                    <div className="section">
                        <h1 onClick={() => setShowHighPrototype(!showHighPrototype)} style={{ cursor: 'pointer' }}>
